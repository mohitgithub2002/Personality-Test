...
<nav className="bg-white border-gray-200 shadow-black drop-shadow-xl">
  ...
  <a href="https://relationshipplus.xyz/" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="/logo1.png" className="h-10" alt="Relationship plus Logo" />
      
  </a>
  <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" className="text-black bg-primary hover:bg-gray-100  font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-primary dark:hover:bg-gray-100 dark:focus:bg-gray-100">Login / SignUp</button>
